...
export function createStory(store, props) {
...
export function updateStory({dispatch}, id, props) {
	dispatch('UPDATE_STORY', id, props);
}

export function deleteStory({dispatch}, id) {
	dispatch('DELETE_STORY', id);
}

export function duplicateStory({dispatch}, id, newName) {
	dispatch('DUPLICATE_STORY', id, newName);
}

export function importStory({dispatch}, toImport) {
	dispatch('IMPORT_STORY', toImport);
}

export function setTagColorInStory(store, storyId, tagName, tagColor) {
...
export function cleanUpTagColorsInStory(store, storyId) {
...
export function repairStories(store) {
