...
describe('story format actions module', () => {
	...
	it('creates built-in formats with repairFormats()', () => {
		...
		expect(created['Harlowe-3.0.0']).to.exist;
		expect(created['Harlowe-3.0.0'].url).to.equal('story-formats/harlowe-3.0.0/format.js');
		expect(created['Harlowe-3.0.0'].userAdded).to.be.false;
		...
		expect(created['SugarCube-2.28.1']).to.exist;
		expect(created['SugarCube-2.28.1'].url).to.equal('story-formats/sugarcube-2.28.1/format.js');
		expect(created['SugarCube-2.28.1'].userAdded).to.be.false;
	});
