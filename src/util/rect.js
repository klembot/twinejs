/*
Utility functions for dealing with rectangles. These always expect rectangles to
be specified as objects with { top, left, width, height } properties.
*/
...
/*
Returns the intersection point between a rectangle and a line segment. If none
exists, this returns null.
*/

export function intersectionWithLine(rect, segmentStart, segmentEnd) {
	let result;
...
export function displace(movable, stationary, spacing = 0) {
