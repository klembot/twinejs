...
module.exports = function (options)
{
	...
	{
		content: Marionette.Renderer.render(promptTemplate,
				 _.defaults(options, { confirmClass: 'primary', confirmLabel: 'OK', cancelLabel: 'Cancel', defaultValue: '' }))
	});

	promptModal.on('modalOpen.twineui', function()
	{
