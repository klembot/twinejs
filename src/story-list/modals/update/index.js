/*
# story-list/modals/update

Exports a view which displays a modal if there's a new version of the
...
module.exports = {
	...
	*/
	...
	/*
	Checks for a new version, and if it exists, shows the modal.
