<template>
	<path
		:d="pathString"
		:style="classStyle"
		:class="`link-arrow marker-${markerType}`"
	></path>
</template>
<script>
...
const arc = ({start, radius, end, largeArc, sweep, rotation}) =>
	'M' +
	start.left +
	',' +
	start.top +
...
export default {
	...
	props: {
		/*
		The start passage. It must have height, left, top, and width properties.
		*/
		start: {required: true, type: Object},

		/*
		The end passage. It must have height, left, top, and width properties.

		It's OK for this to be null or undefined; in those cases, we draw a
		broken link indicator.
		*/
		end: {required: false, type: Object}
	}
};
</script>
