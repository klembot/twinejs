...
module.exports = Marionette.ItemView.extend({
	...
	animEndEvent: 'animationend webkitAnimationEnd MSAnimationEnd',
	...
	appear: function(callback) {
		var animEndEvent = this.animEndEvent;

		if (callback) {
			this.$el.on(animEndEvent, function() {
				callback();
 ...
 if (e.originalEvent.targetTouches) {
	...
	trackDrag: function(e) {
		...
		$('body').trigger($.Event('passagedrag', {
