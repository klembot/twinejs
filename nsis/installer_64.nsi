...
Name "Twine 2.0.8"
OutFile "..\dist\twine_2.0.8_win64.exe"
...
DirText "Choose which folder to install Twine 2.0.8 into:"
...
CreateShortCut "$SMPROGRAMS\Twine 2\Uninstall.lnk" "$INSTDIR\uninstall.exe"

; add uninstall entry in Add/Remove Programs

WriteRegStr HKEY_LOCAL_MACHINE "SOFTWARE\Twine2" "" "$INSTDIR"
WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Uninstall\Twine2" "DisplayName" "Twine 2.0.8 (remove only)"
WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Uninstall\Twine2" "UninstallString" '"$INSTDIR\uninstall.exe"'
...
UninstallText "This will uninstall Twine 2.0.8 from your system."
