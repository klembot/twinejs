...
Name "Twine 2.0.7"
OutFile "..\dist\download\twine_2.0.7_win64.exe"
...
WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Uninstall\Twine2" "DisplayName" "Twine 2.0.7 (remove only)"
...
UninstallText "This will uninstall Twine 2.0.7 from your system."
