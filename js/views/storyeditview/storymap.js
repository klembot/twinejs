/**
 Manages the storymap of a StoryEditView, specifically the arrows
 connecting linked passages.

 @class StoryEditView.StoryMap
 @extends Backbone.View
**/

StoryEditView.StoryMap = Backbone.View.extend(
{
	initialize: function (options)
	{
		...
		**/
		...
		.listenTo(this.parent.collection, 'change:top change:left', this.resize)
		...
		{
			this.collection.each(function(item) { this.cachePassage(item) });
			this.drawLinks();
		}, this), 0);
	},
